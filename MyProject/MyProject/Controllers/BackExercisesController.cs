...
namespace MyProject.Controllers
{
    public class BackExercisesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ExerciseId,BackParty,ExerciseName,Reps,BreakTime")] BackExercises backExercises)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ExerciseId,BackParty,ExerciseName,Reps,BreakTime")] BackExercises backExercises)
        {
